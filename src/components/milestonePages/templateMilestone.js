...
import DateActivity from "../layout/dateActivityComponent"
import Indicators from "../indicators/indicatorsComponent"
...
export default function Milestone({ data, pageContext }) {
 ...
 // console.log("datagrafica", data.getCourse.ora_IndicadorHitoOes)
  ...
  const typeViewTemplate = "milestone"
  ...
  return (
    <div className={classes.root}>
      ...
      <main className={classes.content}>
        ...
        {/* date milestones */}
        <DateActivity dateActivitySchema={data.getCourse.Hitopage} objectSelected={titleMilestone} selectorPeriodoSchema={data.getCourse.SelectorHito} periodoDefault={pageContext.periodo} onChangeTitleMilestone={(titleMilestone) => setTitleMilestone(titleMilestone)} />

        {/* Background indicator */}
        <Indicators  indicatorsSchema={data.getCourse.Hitopage}  dataGrafica={data.getCourse.ora_IndicadorHitoOes} dataAct={data.getCourse.fechaACt} dataAnt={data.getCourse.fechaAnt} />
...
export const query = graphql`
  query milestoneTemplate($periodo: String!, $hito: String!,  $codigo: Int!, $codigoAnt: Int!, $abreviacionOE: String!) {
  getCourse {
    hitos:  ora_HitoOes(
      where: {
        periodo:{
